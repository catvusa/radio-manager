        ...
        "fields" => array(
          array(
            ...
            "sub_fields" => array(
              ...
              array(
                "key" => "field_60f6e39d8cfd3",
                "label" => "Cancel Button Label",
                "name" => "rm_radio_cancel",
                "type" => "text",
                "instructions" => "Set the label of the cancel button.",
                "required" => 0,
                "conditional_logic" => 0,
                "wrapper" => array(
                  "width" => "",
              ...
              array(
                "key" => "field_60f6e3ab8cfd4",
                "label" => "Confirm Button Label",
                "name" => "rm_radio_confirm",
                "type" => "text",
                "instructions" => "Set the label of the confirm button.",
                "required" => 0,
                "conditional_logic" => 0,
                "wrapper" => array(
                  "width" => "",
