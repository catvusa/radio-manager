                    ...
                    array(
                        ...
                        'sub_fields' => array(
							...
							array(
								...
								'type' => 'text',
								'instructions' => 'There you can set a caption for the musician\'s name.',
								'required' => 0,
								'conditional_logic' => 0,
								'wrapper' => array(
									'width' => '',
							...
							array(
								...
								'type' => 'text',
								'instructions' => 'There you can set a caption for the record\'s name.',
								'required' => 0,
								'conditional_logic' => 0,
								'wrapper' => array(
									'width' => '',
                    ...
                    array(
                        ...
                        'sub_fields' => array(
                            ...
                            array(
                                ...
                                'name' => 'rm_radio_link',
                                'type' => 'url',
                                'instructions' => 'The URL link of the OK button.',
                                'required' => 0,
                                'conditional_logic' => 0,
                                'wrapper' => array(
                                    'width' => '',
